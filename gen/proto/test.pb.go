...
type ResponseRequest struct {
	...
	Nsg string `protobuf:"bytes,1,opt,name=nsg,proto3" json:"nsg,omitempty"`
}
...
func (x *ResponseRequest) GetNsg() string {
	if x != nil {
		return x.Nsg
	}
	return ""
...
var file_test_proto_rawDesc = []byte{
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x6e, 0x73, 0x67, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x03, 0x6e, 0x73, 0x67, 0x22, 0x1d, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x52,
